...
export const metadata: Metadata = {
  title: "EU Compliance Notice | UAE Biz Connect",
  description: "How UAE Biz Connect addresses GDPR, DSA, EAA/WCAG, AI transparency, and consumer protection requirements.",
...
export default function EuCompliancePage() {
  return (
    <LegalLayout title="EU Compliance Notice (2026)">
      <p>
        UAE Biz Connect applies a compliance baseline aligned with key EU digital requirements, including GDPR,
      ...
      <p>
        Compliance inquiries: <a className="text-blue-600 hover:underline" href="mailto:info@uaebizconnect.com">info@uaebizconnect.com</a>
      </p>
    </LegalLayout>
  );
}
