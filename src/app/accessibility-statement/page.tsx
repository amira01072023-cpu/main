...
export const metadata: Metadata = {
  title: "Accessibility Statement | UAE Biz Connect",
  description: "Accessibility commitment and conformance statement for UAE Biz Connect.",
};
...
export default function AccessibilityStatementPage() {
  return (
    <LegalLayout title="Accessibility Statement">
      <p>
        UAE Biz Connect is committed to digital accessibility and aims to align with WCAG 2.2 Level AA.
      </p>
